...
def acre2sqft(acres: float) -> float:
    """Convert a number from acers to square feet."""

    return acres * 43560


def circle_area2radius(area: float) -> float:
    """Get a circle's radius given its area.

    Output unit will be square-root of input unit.
    """
